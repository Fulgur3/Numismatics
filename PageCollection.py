...
class PageCollection(Frame):
    def __init__(self, parent, controller):
        ...
        collection_frame = Frame(self, width=1920, height=350, bg="#95e07b")
        ...
        self.settings_img = Label(collection_frame, image=self.settings_image, bg="#95e07b", borderwidth=0)
