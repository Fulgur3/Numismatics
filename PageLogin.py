...
class PageLogin(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        heading = Label(frame, text='Login', fg='#95e07b', bg='white', font=('Microsoft YaHei UI Light', 23, 'bold'))
        ...
        self.login_btn = Button(
            frame, width=30, pady=7, text='Login', bg='#95e07b', fg='white', border=0,
        ...
        self.register_btn = Button(
            frame, width=8, text="Register", border=0, bg='white', cursor='hand2', fg='#95e07b',
