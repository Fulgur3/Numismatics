...
class WindowCoinCreateEditSearch(Toplevel):
    def __init__(self, controller, window_mode, coin_id=None, offer_username=None):
        ...
        self.sell_delete_btn = Button(
            self.frame_btn, width=30, pady=7, text='', bg='#95e07b', fg='white', border=0,
        ...
        self.refresh_btn = Button(
            self.frame_btn_sale, width=30, pady=7, text='Refresh', bg='#95e07b', fg='white', border=0,
        ...
        self.make_offer_btn = Button(
            self.frame_btn_sale, width=30, pady=7, text='Make offer', bg='#95e07b', fg='white', border=0,
        ...
        self.search_btn = Button(
            self.frame_search_btn, width=30, pady=7, text='Search', bg='#95e07b', fg='white', border=0,
            font=('Microsoft YaHei UI Light', 11, 'bold'), command=lambda: self.create_edit_save_search()
        )
