...
class PageHome(Frame):
    def __init__(self, parent, controller):
        ...
        account_frame = Frame(self, width=1920, height=100, bg="#95e07b")
        ...
        self.settings_img = Label(account_frame, image=self.settings_image, bg="#95e07b", borderwidth=0)
        ...
        self.back_img = Label(account_frame, image=self.back_image, bg="#95e07b", borderwidth=0)
        self.back_img.place(x=1720, y=0)
        self.back_img.bind("<Button-1>", self.close)

        self.profile_name = Label(
            account_frame, text="", fg='white', bg='#95e07b',
            font=('Microsoft YaHei UI Light', 24, 'bold')
        )
        self.profile_name.place(x=120, y=25)

        section_buttons_frame = Frame(self, width=1920, height=50, bg="#95e07b")
        ...
        self.search_btn = Button(
            self.search_top_frame, width=30, pady=7, text='Search', bg='#95e07b', fg='white', border=0,
        ...
        self.search_token_btn = Button(
            self.search_top_frame, width=30, pady=7, text='Search by details', bg='#95e07b', fg='white', border=0,
        ...
        self.show_statistics_btn = Button(
            self.statistics_frame, width=30, pady=7, text='Show', bg='#95e07b', fg='white', border=0,
